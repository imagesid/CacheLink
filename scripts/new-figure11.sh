...
WORKLOADS=("workloads/workloadb" "workloads/workloadc" "workloads/workloadd")
...
CSV="/workspace/CacheLink/scripts/new-figure11.csv"
...
run_test() {
    ...
    LOG_FILE="$LOG_DIR/${NAME}_${WORKLOAD_NAME}_${RDIST}-big.txt"
...
run_test_cachelink() {
    ...
    LOG_FILE="$LOG_DIR/${NAME}_${WORKLOAD_NAME}_${POLICY}_${RDIST}-big.txt"
